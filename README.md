...
- Jinja2 variables usage is to isolate data and allow redefinitions of attributes in templates.  Observe "{% variable = %}" syntax for definition and "{{ variable }}" for reference.
